...
#SQL BÁSICO DESDE DENTRO DE PYTHON
import sqlite3
...
#INSERT TABLE - MULTIPLES LINEAS
c.execute("""INSERT INTO coffees VALUES (null, 'French_Roast', 8.99);""")
c.execute("""INSERT INTO coffees VALUES (null, 'Espresso', 9.99);""")
c.execute("""INSERT INTO coffees VALUES (null, 'Colombian_Decaf', 8.99);""")
c.execute("""INSERT INTO coffees VALUES (null, 'French_Roast_Decaf', 9.99);""")
conn.commit()
for fila in c.execute("SELECT * FROM coffees"):
    print("id=",fila[0])
    print("Nombre=",fila[1])
...
#DELETE - BORRANDO UNA LINEA
c.execute("""DELETE FROM coffees WHERE id=5""")
conn.commit()
